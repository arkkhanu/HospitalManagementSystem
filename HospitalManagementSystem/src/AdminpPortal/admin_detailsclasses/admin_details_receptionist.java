 ...
 * @author AbdulRehman
 */
public class admin_details_receptionist extends javax.swing.JFrame {

    /**
     * Creates new form admin_details_receptionist
     */
    public admin_details_receptionist() {
        initComponents();
        showtime();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "RID", "F-Name", "L-Name", "DOB", "Age", "Sex", "Ph-No", "City", "Reg-Date", "Email", "Password", "Address", "Qualification", "Salary"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_details_receptionist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_details_receptionist().setVisible(true);
            }
        });
    }
