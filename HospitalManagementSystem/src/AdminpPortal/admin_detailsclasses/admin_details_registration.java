 ...
 * @author AbdulRehman
 */
public class admin_details_registration extends javax.swing.JFrame {

    /**
     * Creates new form admin_details_registration
     */
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PID", "F-Name", "L-Name", "DOB", "Age", "Sex", "Ph-No", "City", "Recept", "In-Reg-Date", "Address"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_details_registration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_details_registration().setVisible(true);
            }
        });
    }
